    ...
    return (
       ...
       <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-10 sm:gap-20 md:gap-20 p-10 sm:p-20 md:p-20 ">
            {projects.map(project => (
                <div key={project.id} className="relative overflow-hidden rounded-xl shadow-md transition duration-300 ease-in-out transform hover:shadow-xl hover:-translate-y-3 bg-gray-500 bg-opacity-30 cursor-pointer mb-20">
                    ...
                    <div className="p-4">
                        ...
                        <a href={project.githubLink} target="_blank" rel="noopener noreferrer">
                            <FontAwesomeIcon icon={faGithub} className="text-white text-4xl mr-4 ml-2 mt-2"/>
                        </a>
                        {project.playStoreLink && (
                            <a href={project.playStoreLink} target="_blank" rel="noopener noreferrer">
                                <FontAwesomeIcon icon={faGooglePlay} className="text-white text-lg"/>
                            </a>
                        )}
                    </div>
                </div>
